...
To see your changes, [install Hugo Extended], then execute it with:
...
Your version of Hugo is might be too old. Please use the latest version specified in [netlify.toml]

# Translations - internationalization (i18n)

For better help with translation, please see [TRANSLATION.md].
