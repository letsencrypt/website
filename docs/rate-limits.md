...
We have also recently introduced a rate limit on overall request volume. The
"new-reg", "new-authz" and "new-cert" endpoints have an **Overall Request Per
Second** rate limit of 20 requests per second. All other endpoints have a rate
limit of 2000 requests per second.
