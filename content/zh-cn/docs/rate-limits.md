...
如果您达到了速率限制，我们没有办法帮助您暂时重置它。 您需要等待一周，直到这些速率限制过期。 我们使用了滑动窗口的方式，因此如果你在周一申请签发了25张证书，并且在周五又申请签发了25张证书，那么下周一起你将可以再次申请签发证书。 您可以[在 crt.sh 网站上搜索](https://crt.sh)您的域名成功申请过的证书，该网站使用的是公开的[证书透明化](https://www.certificate-transparency.org)日志。
