...
[![Schéma hierarchie certifikátů ISRG, stav k červenci 2026](/images/isrg-hierarchy.png)](/images/isrg-hierarchy-full.png)

# Kořenové CA

Naše kořenové klíčové materiuály jsou uloženy bezpečně offline. Vydáváme certifikáty koncových entit předplatitelům ze zprostředkovatelů popsaných v následující části.
...
* **ISRG Root X1**
  * Předmět: `C=US, O=Internet Security Research Group, CN=ISRG Root X1`
  * Typ klíče: ` RSA 4096`
...
* **ISRG Root X2**
  * Předmět: `C=US, O=Internet Security Research Group, CN=ISRG Root X2`
...
* **ISRG Root YE**
  * Předmět: `C=US, O=ISRG, CN=Root YE`
  * Typ klíče: `ECDSA P-384`
...
* **ISRG Root YR**
  * Předmět: `C=US, O=ISRG, CN=Root YR`
  * Typ klíče: ` RSA 4096`
  * Důvěryhodné do: N/A (vygenerováno 2025-09-03)
...
V současné době udržujeme čtyři zprostředkující certifikáty, které aktivně rotují. Certifikáty odběratelů obsahující veřejný klíč ECDSA budou vydávány jedním ze zprostředkovatelů ECDSA; podobně certifikáty odběratelů obsahující veřejný klíč RSA budou vydávány jedním ze zprostředkovatelů RSA.

* **Let's Encrypt YE1**
  * Předmět: `C=US, O=Let's Encrypt, CN=YE1`
  * Typ klíče: `ECDSA P-384`
  ...
  * Řetězce:
    ...
    * EE ← YE1 ← Root YE
* **Let's Encrypt YE2**
  * Předmět: `C=US, O=Let's Encrypt, CN=YE2`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2028-09-02
  ...
  * Řetězce:
    ...
    * EE ← YE2 ← Root YE
* **Let's Encrypt YR1**
  * Předmět: `C=US, O=Let's Encrypt, CN=YR1`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2028-09-02
  ...
  * Řetězce:
    ...
    * EE ← YR1 ← Root YR
* **Let's Encrypt YR2**
  * Předmět: `C=US, O=Let's Encrypt, CN=YR2`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2028-09-02
...
* **Let's Encrypt YE3**
  * Předmět: `C=US, O=Let's Encrypt, CN=YE3`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2028-09-02
...
* **Let's Encrypt YR3**
  * Předmět: `C=US, O=Let's Encrypt, CN=YR3`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2028-09-02
...
Tyto zprostředující certifikační autority již nejsou používány k vydávání certifikátů předplatitelů. Ti, kteří vydali nějaké certifikáty, budou i nadále vytvářet seznamy CRL až do vypršení jejich platnosti.

* **Let's Encrypt E5**
  * Předmět: `C=US, O=Let's Encrypt, CN=E5`
  * Typ klíče: `ECDSA P-384`
...
* **Let's Encrypt E6**
  * Předmět: `C=US, O=Let's Encrypt, CN=E6`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2027-03-12
...
* **Let's Encrypt E7**
  * Předmět: `C=US, O=Let's Encrypt, CN=E7`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2027-03-12
...
* **Let's Encrypt E8**
  * Předmět: `C=US, O=Let's Encrypt, CN=E8`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2027-03-12
...
* **Let's Encrypt E9**
  * Předmět: `C=US, O=Let's Encrypt, CN=E9`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2027-03-12
  * Podrobnosti CA: [crt.sh](https://crt.sh/?caid=295812), [vydané certifikáty](https://crt.sh/?Identity=%25&iCAID=295812)
  * Podrobnosti certifikátu (podepsaný ISRG Root X2): [crt.sh](https://crt.sh/?id=12396132899), [der](/certs/2024/e9.der), [pem](/certs/2024/e9.pem), [txt](/certs/2024/e9.txt)
...
* **Let's Encrypt R10**
  * Předmět: `C=US, O=Let's Encrypt, CN=R10`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2027-03-12
...
* **Let's Encrypt R11**
  * Předmět: `C=US, O=Let's Encrypt, CN=R11`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2027-03-12
...
* **Let's Encrypt R12**
  * Předmět: `C=US, O=Let's Encrypt, CN=R12`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2027-03-12
...
* **Let's Encrypt R13**
  * Předmět: `C=US, O=Let's Encrypt, CN=R13`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2027-03-12
...
* **Let's Encrypt R14**
  * Předmět: `C=US, O=Let's Encrypt, CN=R14`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2027-03-12
...
<details>
<summary>S vypršenou platností</summary>

Tyto zprostředkující certifikační autority nemohou vydávat certifikáty účastníků.

* **Let's Encrypt Authority X1**
  * Předmět: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X1`
  * Typ klíče: ` RSA 2048`
...
* **Let's Encrypt Authority X2**
  * Předmět: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X2`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2020-06-04 (vypršelo)
...
* **Let's Encrypt Authority X3**
  * Předmět: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X3`
  * Typ klíče: ` RSA 2048`
...
* **Let's Encrypt Authority X4**
  * Předmět: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X4`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2021-10-06 (vypršelo)
...
* **Let's Encrypt E1**
  * Předmět: `C=US, O=Let's Encrypt, CN=E1`
  * Typ klíče: `ECDSA P-384`
...
* **Let's Encrypt E2**
  * Předmět: `C=US, O=Let's Encrypt, CN=E2`
  * Typ klíče: `ECDSA P-384`
  * Platný do: 2025-09-15 (expirovaný)
...
* **Let's Encrypt R3**
  * Předmět: `C=US, O=Let's Encrypt, CN=R3`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2025-09-15 (expirovaný)
...
* **Let's Encrypt R4**
  * Předmět: `C=US, O=Let's Encrypt, CN=R4`
  * Typ klíče: ` RSA 2048`
  * Platný do: 2025-09-15 (expirovaný)
