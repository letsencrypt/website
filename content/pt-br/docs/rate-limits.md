...
nosso {{<link "ambiente de testes" "/docs/staging-environment.md" >}} ao invés da API de produção.
Se você está trabalhando para integrar a Let's Encrypt a um provedor ou a um website
muito grande por favor {{<link "leia nosso Guia de Integração" "/docs/integration-guide.md" >}}.
...
por conta, por nome de domínio, por hora. Este limite é maior em nosso {{<link "ambiente de testes" "/docs/staging-environment.md" >}}, você
...
grandes integradores {{<link "usem uma conta para muitos usuários" "/docs/integration-guide.md" >}}.
...
Por favor use nosso {{<link "ambiente de testes" "/docs/staging-environment.md" >}} se você está
