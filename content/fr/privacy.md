...
Vous pouvez avoir la possibilité de fournir des informations de contact, telles que votre adresse électronique, à des fins de service et de récupération du compte. Vos coordonnées ne seront pas rendues publiques et ne seront partagées qu'en vertu de la section "Application de la loi et circonstances atténuantes" ci-dessous. En fournissant votre adresse électronique, vous acceptez de recevoir de notre part des courriers électroniques relatifs à nos services. Vous pouvez à tout moment vous désabonner des courriels liés au service en cliquant sur le lien "unsubscribe" au bas de nos courriels ou en nous contactant à l'adresse privacy@abetterinternet.org. Nous n'utiliserons pas vos coordonnées à des fins de marketing ou de promotion sans votre consentement.

Il se peut que vous deviez télécharger le logiciel client à partir d'un dépôt tel que ceux gérés par Debian, Ubuntu, Red Hat ou GitHub. Votre interaction avec un tel dépôt de logiciels est régie par la politique de confidentialité et/ou les conditions d'utilisation de ce dépôt.
...
**Objectif:** Fournir des informations sur l'état du certificat
