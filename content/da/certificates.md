...
[![ISRG Certifikate Hierarki Diagram, fra juli 2026](/images/isrg-hierarchy.png)](/images/isrg-hierarchy-full.png)

# Root CAs

Vores root certifikater holdes sikkert offline. Vi udsteder end-entity certifikater til abonnenter fra intermediate certifikater som beskrevet i næste afsnit.
...
* **ISRG Root X2**
  * Emne: `C=US, O=Internet Security Research Group, CN=ISRG Root X2`
...
* **Let's Encrypt YE1**
  * Emne: `C=US, O=Let's Encrypt, CN=YE1`
  * Nøgletype: `ECDSA P-384`
  ...
  * Certifikat kæder:
    ...
    * EE ← YE1 ← Root YE
* **Let's Encrypt YE2**
  * Emne: `C=US, O=Let's Encrypt, CN=YE2`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2028-09-02
  ...
  * Certifikat kæder:
    ...
    * EE ← YE2 ← Root YE
* **Let's Encrypt YR1**
  * Emne: `C=US, O=Let's Encrypt, CN=YR1`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2028-09-02
  ...
  * Certifikat kæder:
    ...
    * EE ← YR1 ← Root YR
* **Let's Encrypt YR2**
  * Emne: `C=US, O=Let's Encrypt, CN=YR2`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2028-09-02
...
* **Let's Encrypt YE3**
  * Emne: `C=US, O=Let's Encrypt, CN=YE3`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2028-09-02
...
* **Let's Encrypt YR3**
  * Emne: `C=US, O=Let's Encrypt, CN=YR3`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2028-09-02
...
Disse underordnede CA'er bruges ikke længere til at udstede Abonnentcertifikater. De certifikater, der har udstedt certifikater, vil fortsat producere CRL'er, indtil de udløber.

* **Let's Encrypt E5**
  * Emne: `C=US, O=Let's Encrypt, CN=E5`
  * Nøgletype: `ECDSA P-384`
...
* **Let's Encrypt E6**
  * Emne: `C=US, O=Let's Encrypt, CN=E6`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt E7**
  * Emne: `C=US, O=Let's Encrypt, CN=E7`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt E8**
  * Emne: `C=US, O=Let's Encrypt, CN=E8`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt E9**
  * Emne: `C=US, O=Let's Encrypt, CN=E9`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2027-03-12
  * CA detaljer: [crt.sh](https://crt.sh/?caid=295812), [udstedte certifikater](https://crt.sh/?Identity=%25&iCAID=295812)
  * Certifikat detaljer (underskrevet af ISRG Root X2): [crt.sh](https://crt.sh/?id=12396132899), [der](/certs/2024/e9.der),[pem](/certs/2024/e9.pem),[txt](/certs/2024/e9.txt)
...
* **Let's Encrypt R10**
  * Emne: `C=US, O=Let's Encrypt, CN=R10`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt R11**
  * Emne: `C=US, O=Let's Encrypt, CN=R11`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt R12**
  * Emne: `C=US, O=Let's Encrypt, CN=R12`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt R13**
  * Emne: `C=US, O=Let's Encrypt, CN=R13`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2027-03-12
...
* **Let's Encrypt R14**
  * Emne: `C=US, O=Let's Encrypt, CN=R14`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2027-03-12
...
<details>
<summary>Udløbet</summary>

Disse midlertidige CA'er kan ikke udstede Abonnementscertifikater.

* **Let's Encrypt Autoriteten X1**
  * Emne: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X1`
  * Nøgletype: `RSA 2048`
...
* **Let's Encrypt Autoriteten X2**
  * Emne: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X2`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2020-06-04 (udløbet)
...
* **Let's Encrypt Autoriteten X3**
  * Emne: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X3`
  * Nøgletype: `RSA 2048`
...
* **Let's Encrypt Autoriteten X4**
  * Emne: `C=US, O=Let's Encrypt, CN=Let's Encrypt Authority X4`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2021-10-06 (udløbet)
...
* **Let's Encrypt E1**
  * Emne: `C=US, O=Let's Encrypt, CN=E1`
  * Nøgletype: `ECDSA P-384`
...
* **Let's Encrypt E2**
  * Emne: `C=US, O=Let's Encrypt, CN=E2`
  * Nøgletype: `ECDSA P-384`
  * Gyldig indtil: 2025-09-15 (udløbet)
...
* **Let's Encrypt R3**
  * Emne: `C=US, O=Let's Encrypt, CN=R3`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2025-09-15 (udløbet)
...
* **Let's Encrypt R4**
  * Emne: `C=US, O=Let's Encrypt, CN=R4`
  * Nøgletype: `RSA 2048`
  * Gyldig indtil: 2025-09-15 (udløbet)
