...
Let's Encrypt を使い始めるには、[はじめる]({{< ref "/getting-started.md" >}})のページを読んでください。
...
私たちがサービスを世界中に提供し続けるためには、たくさんのスポンサー・助成金・個人からの支援が必要です。もしあなたが支援に興味を持ってくれたのなら、ぜひとも[寄付を行う]({{< ref "/donate.html" >}})ことや[スポンサーになる]({{< ref "/become-a-sponsor.html" >}})ことを検討してください。よろしくお願いします。
...
1. 私たちは非常に役に立つ[ドキュメント]({{< ref "/docs" >}})を提供します。
...
はい、ほとんどすべてのブラウザとオペレーティングシステムに信頼されます。詳しくは、[互換性リスト]({{< ref "/docs/cert-compat.md" >}})を見てください。
...
たくさんの [ACME クライアント]({{< ref "/docs/client-options.md" >}})が利用可能なので、あなたのオペレーティングシステムでも動作するクライアントがある可能性は高いです。初めて利用する場合、私たちは [Certbot](https://certbot.eff.org/) を使うことをおすすめしています。 
