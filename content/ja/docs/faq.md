...
私たちがサービスを世界中に提供し続けるためには、たくさんのスポンサー・助成金・個人からの支援が必要です。もしあなたが支援に興味を持ってくれたのなら、ぜひとも[寄付を行う]({{< relref "/donate.html" >}})ことや[スポンサーになる]({{< relref "/become-a-sponsor" >}})ことを検討してください。よろしくお願いします。
