...
Let's Encrypt unterstützt die ACMEv2 API, welche kompatibel ist mit dem [finalisierten ACME Standard](https://tools.ietf.org/html/rfc8555). Im Juni 2021 haben wir [die Unterstützung für ACMEv1](https://community.letsencrypt.org/t/end-of-life-plan-for-acmev1/88430/27) eingestellt. Wenn Sie bereits einen dieser Clients verwenden, stellen Sie sicher, dass Sie auf die neueste Version aktualisieren. Wenn der von Ihnen verwendete Client unten nicht aufgeführt ist, wenden Sie sich an die Projektbetreuer, oder wechseln Sie zu einem anderen Client.
...
1. Der Client führt [routinemäßige Erneuerungen zu zufälligen Zeitpunkten](/docs/integration-guide#when-to-renew) durch, oder er unterstützt diese Konfiguration.
