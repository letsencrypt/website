...
Dei Staging-Umgebung benutzt dieselben Rate Limits wie {{<link "beschrieben für unsere Produktionsumgebung" "/docs/rate-limits.md" >}} mit den folgenden Ausnahmen:
