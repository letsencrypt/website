...
benutzen Sie unsere {{<link "Staging Umgebung" "/docs/staging-environment.md" >}} anstatt
die Produktions API.
Wenn Sie an der Integration von Let's Encrypt als Provider arbeiten oder
einer grossen Webseite bitte {{<link "lesen Sie unseren Integration Guide" "/docs/integration-guide.md" >}}.
...
dass grosse Integratoren ein Design von {{<link "ein Konto für viele Kunden" "/docs/integration-guide.md" >}}
verwenden.
...
Bitte benutzen Sie unsere {{<link "Staging Umgebung" "/docs/staging-environment.md" >}},
