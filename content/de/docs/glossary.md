...
{{% def id="ACME-server" name="ACME Server" %}} Ein ACME-kompatibler Server, der [Zertifikate](#def-leaf) generieren kann. [Boulder](#def-boulder), eine Software von Let's Encrypt, ist ACME-kompatibel <a href="https://github.com/letsencrypt/boulder/blob/master[/docs/acme-divergences.md"> aber nicht identisch zu ACME](https://github.com/letsencrypt/boulder/blob/master/docs/acme-divergences.md). {{% /def %}}
