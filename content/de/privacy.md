...
- Fordern Sie einen Bericht über Ihre persönlichen Daten an, indem Sie uns eine E-Mail an privacy@abetterinternet.org schicken. Dieser Bericht enthält die personenbezogenen Daten, die wir über Sie gespeichert haben, und wird Ihnen in einem strukturierten, allgemein verwendeten und tragbaren Format zur Verfügung gestellt. Bitte beachten Sie, dass wir möglicherweise zusätzliche Informationen von Ihnen anfordern, um Ihre Identität zu überprüfen, bevor wir Informationen offenlegen.

- Fordern Sie die Berichtigung oder Löschung Ihrer Daten an, indem Sie uns unter privacy@abetterinternet.org kontaktieren.
