...
Um zu verstehen, wie die Technologie funktioniert, gehen wir die Einrichtung von `example.com` mit einem Zertifikatsverwaltungsagenten durch, der Let's Encrypt unterstützt.
...
* Bereitstellung einer HTTP-Ressource unter einem bekannten URI unter `example.com`
