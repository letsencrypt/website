...
| Certificate Common Name | Yes<sup>*</sup> | No | No |
| Key Encipherment KU | Yes<sup>†</sup> | No | No |
| TLS Client Auth EKU | Yes | No | No |
| Subject Key ID | Yes | No | No |
| Validity Period | 90 days | 90 days | 160 hours |
