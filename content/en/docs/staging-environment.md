...
Also please note that ACME accounts are scoped to each environment, and thus a separate account on the staging environment is required. Certbot handles this for you.
