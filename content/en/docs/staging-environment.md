...
The staging environment submits pre-certificates to the Let's Encrypt {{<link "Testflume" "/docs/ct-logs" >}} and Google [testtube](http://www.certificate-transparency.org/known-logs#TOC-Test-Logs) CT test logs and includes returned SCTs in the issued certificates.
