...
These challenges are why we are working with our partners at the CA/Browser Forum and IETF to standardize a new validation method called [DNS-PERSIST-01](https://datatracker.ietf.org/doc/draft-ietf-acme-dns-persist/). The key advantage of this new method is that the DNS TXT entry used to demonstrate control does not have to change every renewal.
