...
You have the option to provide your email to receive the Let’s Encrypt newsletter through a signup on this web site and via other marketing materials. The newsletter is delivered via MailChimp and your interactions with MailChimp are governed by its privacy policy. We will not retain or use your email address for any purpose other than delivering the newsletter.
