...
- Запросить отчет о личных данных, написав нам на security@letsencrypt.org. Этот отчет будет включать имеющиеся в нашем распоряжении ваши личные данные, предоставленные вам в структурированном, популярном и переносимом формате. Обратите внимание, что мы можем запросить у вас дополнительную информацию, чтобы подтвердить вашу личность, прежде чем раскрывать какую-либо информацию.

- Попросить исправить или удалить вашу информацию, связавшись с нами через security@letsencrypt.org.
