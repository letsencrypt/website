...
Чтобы начать, посетите страницу документации {{<link "Приступая к работе" "/getting-started.md" >}}.
...
Нам нужна поддержка спонсоров, грантодателей и отдельных людей, чтобы предоставлять наши услуги бесплатно по всему миру. Если вы хотите поддержать нас - сделайте {{<link "пожертвование" "/donate.html" >}}, или станьте {{<link "нашим спонсором" "/become-a-sponsor.html" >}}.
...
Да, большинство браузеров и операционных систем доверяют нашим сертификатам. Для подробной информации обратитесь к {{<link "реестру совместимости" "/docs/cert-compat.md" >}}.
...
Есть множество реализаций {{<link "ACME-клиента" "/docs/client-options.md" >}}. Скорее всего, для вашей операционной системы найдётся рабочее решение. На начальном этапе мы рекомендуем использовать [Certbot](https://certbot.eff.org/).
