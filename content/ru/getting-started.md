...
{{<link "множество других ACME-клиентов" "/docs/client-options.md" >}}, со своей документацией. Экспериментировать с различными ACME-клиентами лучше всего на {{<link "тестовых серверах" "/docs/staging-environment.md" >}},
во избежание срабатывания {{<link "ограничений" "/docs/rate-limits.md" >}}.
