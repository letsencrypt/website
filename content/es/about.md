...
Puede leer sobre nuestro último año descargando nuestro [reporte anual](https://www.abetterinternet.org/annual-reports/).
...
* **Abierto:** La emisión automática y el protocolo de renovación [está publicado](https://tools.ietf.org/html/rfc8555) como un estándar abierto para que otros pueden adoptar.
* **Cooperativo:** Al igual que los mismos protocolos subyacentes de Internet, *Let's Encrypt* es un esfuerzo conjunto para el beneficio de la comunidad, más allá del control de cualquier organización.
