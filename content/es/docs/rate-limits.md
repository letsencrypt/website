...
Existe un límite de 5 <a name="failed-validations"></a> **Validaciones Fallidas** por cuenta, por hostname, por hora. Este límite es mayor en nuestro {{<link "entorno de prueba" "/docs/staging-environment" >}}, por lo que puede usar ese entorno para depurar problemas de conectividad.
