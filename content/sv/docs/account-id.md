...
Om du använder [Certbot](https://certbot.eff.org/) och du kör version 1.23.0 eller nyare, kan du hitta ditt konto-ID genom att köra `certbot show_account`-undersubkommandot. Om din Certbot är äldre än 1.23.0, kan du hitta konto-ID genom att titta på fältet "uri" i `/etc/letsencrypt/accounts/acme-v02.api.letsencrypt.org/directory/*/regr.json`.
