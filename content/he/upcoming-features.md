...
ב־11 בפברואר 2026 [הסרנו את השימוש המורחב במפתח (EKU) „אימות לקוח TLS”](https://letsencrypt.org/2025/05/14/ending-tls-client-authentication/) מפרופיל אישורי ברירת המחדל שלנו. כמילוי מקום זמני ללקוחות שצריכים עוד זמן להסבה, יש לנו את פרופיל [tlsclient](https://letsencrypt.org/docs/profiles/#tlsclient) זמין. לקוחות שכבר משתמשים בו לפני 13 במאי, 2026 יכולים להמשיך להשתמש בו עד 8 ביולי, 2026.
